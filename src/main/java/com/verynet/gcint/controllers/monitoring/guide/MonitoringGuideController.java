package com.verynet.gcint.controllers.monitoring.guide;
 ...
 */
@Controller
@RequestMapping(value = "/monitoring/guide")
public class MonitoringGuideController extends GuideTemplateController {

    @Autowired
    public MonitoringGuideController(ControllerUtil controllerUtil, ResourceLoader resourceLoader, DataSource dataSource, JasperUtil jasperUtil) {
        super(controllerUtil, resourceLoader, dataSource, jasperUtil);
    }

    @Override
    public String getView() {
        return "monitoring/guide/guides";
    }
