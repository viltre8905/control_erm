...
<html>
<head>
    <title>Actividades de Control</title>
...
<div class="page-container">
            ...
            <div class="container-fluid container-fixed-lg">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title">Actividades de Control
                        </div>
                        <div class="pull-right">
                            ...
                            <c:if test='${objectProcessSelected.responsible.id==userLogged.id}'>
                                ...
                                <div class="btn-group pull-right col-xs-5">
                                    <button onclick="showAddActivity(null,2)" class="btn btn-primary" type="button">
                                        Adicionar
                                    </button>
                                </div>
                            </c:if>
                                            ...
                                            <security:authorize
                                                ...
                                                <c:if test='${objectProcessSelected.processType()==1}'>
                                                    <th class="sorting" tabindex="0"
                                                        aria-controls="tableWithSearch"
                                                        rowspan="1"
                                                        colspan="1" style="width: 80px;">Sub-Proceso
                                                    </th>
                                                </c:if>
                                            </security:authorize>
                                            <th class="sorting" tabindex="0"
                                                        ...
                                                        <security:authorize
                                                            ...
                                                            <c:if test='${objectProcessSelected.responsible.id==userLogged.id}'>
                                                                ...
                                                                <button class='btn btn-success <c:if test="${activity.activityState.name=='Aceptada'}">disabled</c:if>'
                                                                        type="button"
                                                                        onclick="fillActivityModal(this,2)">
                                                                    <i class="fa fa-pencil"></i>
                                                                </button>
                                                                <button class='btn btn-success <c:if test="${activity.activityState.name=='Aceptada'}">disabled</c:if>'
                                                                        type="button"
                                                                        onclick="deleteActivity(this,2)">
                    ...
                    <button class="btn btn-tag btn-tag-light pull-right m-t-5" type="button"
                            onclick="redirectURL('${pageContext.request.contextPath}/risk/management/identification')">
                        Volver
                    </button>
                </div>
                <!-- END PANEL -->
                            ...
                            <form role="form" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group form-group-default">
                                            <security:authorize access="hasRole('ROLE_PROCESS_SUPERVISORY')">
                                                <label id="editActivitySubProcessLabel">Sub-Proceso</label>
    ...
    <!-- BEGIN ID -->
    <input id="idRisk" type="text" hidden="true" value="${idRisk}"/>
