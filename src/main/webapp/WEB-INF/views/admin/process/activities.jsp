...
<html>
<head>
    <title>Administración de las Actividades</title>
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="content">
            <div class="container-fluid container-fixed-lg">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title">Actividades del <c:choose>
                        ...
                        </c:choose> <i class="pg-arrow_right"></i><span
                                                ...
                                                <div class="row">
                                                    <div class="btn-group b-grey b-l b-r p-l-15 p-r-15">
                                                        <button class="btn btn-success" type="button"
                                                                ...
                                                                onclick="fillActivityProcessModal(this)"><i
                                                                class="fa fa-pencil"></i>
                                                        </button>
                                                        <button class="btn btn-success" type="button"
                                                                data-toggle="tooltip"
                                                                data-original-title="Eliminar"
                                                                onclick="deleteActivityProcess(this)"><i
                                                                class="fa fa-trash-o"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                                <input type="text" hidden="true" value="${activity.id}"/>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <button class="btn btn-tag btn-tag-light pull-right m-t-5" type="button"
                                    onclick="redirectURL('${pageContext.request.contextPath}/admin/process/sub-process/sub-processes?id=${subProcessId}')">
                                Volver
                            </button>
                        </c:otherwise>
                    </c:choose>
                    ...
                    <div class="modal-content">
                        <div class="modal-header clearfix ">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"
                                    onclick="cleanActivityProcessModal();"><i
                                    class="pg-close fs-14"></i>
                            </button>
                            <h4 class="p-b-5"><span class="semi-bold">Nueva</span> Actividad
                        ...
                        <div class="modal-body">
                            <form id="formAddActivityProcess" role="form" method="POST" action="create">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group form-group-default required">
                                            <label>Nombre</label>
                                            <input id="name" name="name" type="text" class="form-control"
                                                   placeholder="Nombre de la actividad" required="true">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group form-group-default">
                                            ...
                                            <select id="responsible" name="responsible"
                                                ...
                                                <c:forEach var="user" items="${process.members}">
                                                    <c:if test='${user.hasRole("ROLE_ACTIVITY_RESPONSIBLE")}'>
                                ...
                                <div class="row">
                                    ...
                                    <textarea id="description" name="description"
                                              placeholder="Descripción de la actividad" rows="2" class="full-width"
                                ...
                                <button type="submit" class="btn btn-primary  btn-cons pull-right"
                                        onclick="if (validateActivityProcess()) {
                               addActivityProcess();}return false;">Aceptar
                                </button>
                            </form>
                        </div>
            ...
            <div class="modal fade stick-up" id="editAppModalActivityProcess" tabindex="-1" role="dialog"
                 aria-labelledby="editAppModalActivityProcess" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header clearfix ">
                            ...
                            <h4 class="p-b-5"><span class="semi-bold">Modificar</span> Actividad: <span
                                    id="activityProcessTitle"></span>
                        ...
                        <div class="modal-body">
                            <form role="form" method="POST" action="">
                                ...
                                <button id="edit-activity-process" type="button"
    ...
    <!-- BEGIN ID -->
    <input id="idActivityProccess" type="text" hidden="true" value=""/>
    <input id="idProcess" type="text" hidden="true" value="${process.id}"/>
    <!-- END ID -->
    <!-- BEGIN JS -->
    <%@include file="/WEB-INF/views/template/script.jsp" %>
    <script src="${pageContext.request.contextPath}/resources/js/admin/process/activity.js"
