-- Function: f_activity_general_supervisory(integer, integer, integer)

-- DROP FUNCTION f_activity_general_supervisory(integer, integer, integer);

CREATE OR REPLACE FUNCTION f_activity_general_supervisory(process integer, component integer)
...
for 
 ...
 in
  ...
  where 
      ...
      activity.component_id=component
 loop
  a.code='-';
...
End;$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION f_activity_general_supervisory(integer, integer)
  OWNER TO postgres;